...
\end{center}
 ...
 \begin{flushleft}
     \begin{enumerate}
         \item Dr. Muneendra Ojha, IIIT Allahabad (Supervisor) \\[25pt]
         \item Dr. Krishna Pratap Singh, IIIT Allahabad (Internal Subject Expert) \\[25 pt]
         \item Dr. Kuldip Singh Patel, IIT Patna (External Subject Expert) \\[25 pt]
...
\includepdf[pages=-]{plag_shahil.pdf}
\newpage
\begin{figure}[htp]
    % \centering
    \includegraphics[height=3cm,keepaspectratio]{./IIITA_Header.png}
