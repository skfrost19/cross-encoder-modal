...
\textbf{Infrastructure}: Modal cloud platform with 3 NVIDIA L40S GPUs providing consistent computational environment
...
\begin{itemize}
    \item \textbf{Hardware Consistency}: All experiments on identical 3 L40S GPUs
